...
package com.google.cloudcommerceprocurement.v1;
...
public class CloudCommercePartnerProcurementService extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.25.0-SNAPSHOT of the Cloud Commerce Partner Procurement API library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
  ...
  public class Providers {
    ...
    public class Accounts {
      ...
      Required.
       * @param content the {@link com.google.cloudcommerceprocurement.v1.model.ApproveAccountRequest}
       * @return the request
       */
      public Approve approve(java.lang.String name, com.google.cloudcommerceprocurement.v1.model.ApproveAccountRequest content) throws java.io.IOException {
        Approve result = new Approve(name, content);
        initialize(result);
        return result;
      }

      public class Approve extends CloudCommercePartnerProcurementServiceRequest<com.google.cloudcommerceprocurement.v1.model.Empty> {
      ...
      Required.
         ...
         * @since 1.13
         */
        protected Approve(java.lang.String name, com.google.cloudcommerceprocurement.v1.model.ApproveAccountRequest content) {
          super(CloudCommercePartnerProcurementService.this, "POST", REST_PATH, content, com.google.cloudcommerceprocurement.v1.model.Empty.class);
      ...
      public class Get extends CloudCommercePartnerProcurementServiceRequest<com.google.cloudcommerceprocurement.v1.model.Account> {
        ...
        protected Get(java.lang.String name) {
          super(CloudCommercePartnerProcurementService.this, "GET", REST_PATH, null, com.google.cloudcommerceprocurement.v1.model.Account.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
      ...
      public class List extends CloudCommercePartnerProcurementServiceRequest<com.google.cloudcommerceprocurement.v1.model.ListAccountsResponse> {
        ...
        protected List(java.lang.String parent) {
          super(CloudCommercePartnerProcurementService.this, "GET", REST_PATH, null, com.google.cloudcommerceprocurement.v1.model.ListAccountsResponse.class);
       ...
       * @param name The resource name of the account.
      Required.
       * @param content the {@link com.google.cloudcommerceprocurement.v1.model.RejectAccountRequest}
       * @return the request
       */
      public Reject reject(java.lang.String name, com.google.cloudcommerceprocurement.v1.model.RejectAccountRequest content) throws java.io.IOException {
        Reject result = new Reject(name, content);
        initialize(result);
        return result;
      }

      public class Reject extends CloudCommercePartnerProcurementServiceRequest<com.google.cloudcommerceprocurement.v1.model.Empty> {
      ...
      Required.
         ...
         * @since 1.13
         */
        protected Reject(java.lang.String name, com.google.cloudcommerceprocurement.v1.model.RejectAccountRequest content) {
          super(CloudCommercePartnerProcurementService.this, "POST", REST_PATH, content, com.google.cloudcommerceprocurement.v1.model.Empty.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
    ...
    public class Entitlements {
       ...
       * operation.
       *
       * @param name The resource name of the entitlement.
      Required.
       * @param content the {@link com.google.cloudcommerceprocurement.v1.model.ApproveEntitlementRequest}
       * @return the request
       */
      public Approve approve(java.lang.String name, com.google.cloudcommerceprocurement.v1.model.ApproveEntitlementRequest content) throws java.io.IOException {
        Approve result = new Approve(name, content);
        initialize(result);
        return result;
      }
      ...
      Required.
         ...
         * @since 1.13
         */
        protected Approve(java.lang.String name, com.google.cloudcommerceprocurement.v1.model.ApproveEntitlementRequest content) {
          super(CloudCommercePartnerProcurementService.this, "POST", REST_PATH, content, com.google.cloudcommerceprocurement.v1.model.Empty.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
      ...
      /**
       * Approve an entitlement plan change that is in the
       ...
       * @param name The resource name of the entitlement.
      Required.
       * @param content the {@link com.google.cloudcommerceprocurement.v1.model.ApproveEntitlementPlanChangeRequest}
       * @return the request
       */
      public ApprovePlanChange approvePlanChange(java.lang.String name, com.google.cloudcommerceprocurement.v1.model.ApproveEntitlementPlanChangeRequest content) throws java.io.IOException {
        ApprovePlanChange result = new ApprovePlanChange(name, content);
        initialize(result);
        return result;
      }

      public class ApprovePlanChange extends CloudCommercePartnerProcurementServiceRequest<com.google.cloudcommerceprocurement.v1.model.Empty> {
      ...
      Required.
         ...
         * @since 1.13
         */
        protected ApprovePlanChange(java.lang.String name, com.google.cloudcommerceprocurement.v1.model.ApproveEntitlementPlanChangeRequest content) {
          super(CloudCommercePartnerProcurementService.this, "POST", REST_PATH, content, com.google.cloudcommerceprocurement.v1.model.Empty.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
      ...
      public class Get extends CloudCommercePartnerProcurementServiceRequest<com.google.cloudcommerceprocurement.v1.model.Entitlement> {
         ...
         */
        protected Get(java.lang.String name) {
          super(CloudCommercePartnerProcurementService.this, "GET", REST_PATH, null, com.google.cloudcommerceprocurement.v1.model.Entitlement.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
      ...
      public class List extends CloudCommercePartnerProcurementServiceRequest<com.google.cloudcommerceprocurement.v1.model.ListEntitlementsResponse> {
         ...
         */
        protected List(java.lang.String parent) {
          super(CloudCommercePartnerProcurementService.this, "GET", REST_PATH, null, com.google.cloudcommerceprocurement.v1.model.ListEntitlementsResponse.class);
          this.parent = com.google.api.client.util.Preconditions.checkNotNull(parent, "Required parameter parent must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(PARENT_PATTERN.matcher(parent).matches(),
                "Parameter parent must conform to the pattern " +
         ...
         *
         * The filter is a query string that can match a selected set of attributes with string
         * values. For example `account=E-1234-5678-ABCD-EFGH`, `state=pending_cancellation`, and
         * `product!=foo-product`. Supported query attributes are
         *
         * * `account` * `product` * `plan` * `newPendingPlan` or `new_pending_plan` * `state`
         *
         * Note that the state name match is case-insensitive and query can omit the prefix
         * "ENTITLEMENT_". For example, `state=active` is equivalent to `state=ENTITLEMENT_ACTIVE`.
         *
         * If the query contains some special characters other than letters, underscore, or digits,
         * the phrase must be quoted with double quotes. For example,
         * `product="providerId:productId"`, where the product name needs to be quoted because it
         * contains special character colon.
         *
         * Queries can be combined with `AND`, `OR`, and `NOT` to form more complex queries. They
         * can also be grouped to force a desired evaluation order. For example, `state=active AND
         * (account=E-1234 OR account=5678) AND NOT (product=foo-product)`. Connective `AND` can be
         * omitted between two predicates. For example `account=E-1234 state=active` is equivalent
         * to `account=E-1234 AND state=active`.
         */
        @com.google.api.client.util.Key
       ...
       The filter is a query string that can match a selected set of attributes with string values. For
       example `account=E-1234-5678-ABCD-EFGH`, `state=pending_cancellation`, and `product!=foo-product`.
       ...
       * `account` * `product` * `plan` * `newPendingPlan` or `new_pending_plan` * `state`
       ...
       For example, `state=active` is equivalent to `state=ENTITLEMENT_ACTIVE`.

       If the query contains some special characters other than letters, underscore, or digits, the phrase
       must be quoted with double quotes. For example, `product="providerId:productId"`, where the product
       name needs to be quoted because it contains special character colon.

       Queries can be combined with `AND`, `OR`, and `NOT` to form more complex queries. They can also be
       grouped to force a desired evaluation order. For example, `state=active AND (account=E-1234 OR
       account=5678) AND NOT (product=foo-product)`. Connective `AND` can be omitted between two
       predicates. For example `account=E-1234 state=active` is equivalent to `account=E-1234 AND
       state=active`.
         */
       ...
       * @param content the {@link com.google.cloudcommerceprocurement.v1.model.Entitlement}
       * @return the request
       */
      public Patch patch(java.lang.String name, com.google.cloudcommerceprocurement.v1.model.Entitlement content) throws java.io.IOException {
        Patch result = new Patch(name, content);
        initialize(result);
        return result;
      }

      public class Patch extends CloudCommercePartnerProcurementServiceRequest<com.google.cloudcommerceprocurement.v1.model.Entitlement> {
         ...
         * @since 1.13
         */
        protected Patch(java.lang.String name, com.google.cloudcommerceprocurement.v1.model.Entitlement content) {
          super(CloudCommercePartnerProcurementService.this, "PATCH", REST_PATH, content, com.google.cloudcommerceprocurement.v1.model.Entitlement.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
                "Parameter name must conform to the pattern " +
       ...
       * @param name The resource name of the entitlement.
      Required.
       * @param content the {@link com.google.cloudcommerceprocurement.v1.model.RejectEntitlementRequest}
       * @return the request
       */
      public Reject reject(java.lang.String name, com.google.cloudcommerceprocurement.v1.model.RejectEntitlementRequest content) throws java.io.IOException {
        Reject result = new Reject(name, content);
        initialize(result);
        return result;
      }
      ...
      Required.
         ...
         * @since 1.13
         */
        protected Reject(java.lang.String name, com.google.cloudcommerceprocurement.v1.model.RejectEntitlementRequest content) {
          super(CloudCommercePartnerProcurementService.this, "POST", REST_PATH, content, com.google.cloudcommerceprocurement.v1.model.Empty.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
      ...
      /**
       * Reject an entitlement plan change that is in the
       * EntitlementState.ENTITLEMENT_PENDING_PLAN_CHANGE_APPROVAL state.
       *
       ...
       * @param name The resource name of the entitlement.
      Required.
       * @param content the {@link com.google.cloudcommerceprocurement.v1.model.RejectEntitlementPlanChangeRequest}
       * @return the request
       */
      public RejectPlanChange rejectPlanChange(java.lang.String name, com.google.cloudcommerceprocurement.v1.model.RejectEntitlementPlanChangeRequest content) throws java.io.IOException {
        RejectPlanChange result = new RejectPlanChange(name, content);
        initialize(result);
        return result;
      }

      public class RejectPlanChange extends CloudCommercePartnerProcurementServiceRequest<com.google.cloudcommerceprocurement.v1.model.Empty> {
      ...
      Required.
         ...
         * @since 1.13
         */
        protected RejectPlanChange(java.lang.String name, com.google.cloudcommerceprocurement.v1.model.RejectEntitlementPlanChangeRequest content) {
          super(CloudCommercePartnerProcurementService.this, "POST", REST_PATH, content, com.google.cloudcommerceprocurement.v1.model.Empty.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
       ...
       * @param content the {@link com.google.cloudcommerceprocurement.v1.model.SuspendEntitlementRequest}
       * @return the request
       */
      public Suspend suspend(java.lang.String name, com.google.cloudcommerceprocurement.v1.model.SuspendEntitlementRequest content) throws java.io.IOException {
        Suspend result = new Suspend(name, content);
        initialize(result);
        return result;
      }

      public class Suspend extends CloudCommercePartnerProcurementServiceRequest<com.google.cloudcommerceprocurement.v1.model.Empty> {
         ...
         * @since 1.13
         */
        protected Suspend(java.lang.String name, com.google.cloudcommerceprocurement.v1.model.SuspendEntitlementRequest content) {
          super(CloudCommercePartnerProcurementService.this, "POST", REST_PATH, content, com.google.cloudcommerceprocurement.v1.model.Empty.class);
          this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
          if (!getSuppressPatternChecks()) {
            com.google.api.client.util.Preconditions.checkArgument(NAME_PATTERN.matcher(name).matches(),
